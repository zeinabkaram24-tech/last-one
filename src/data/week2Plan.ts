...
export const WEEK2_SPECIAL_NOTES: TomorrowSpecialNote[] = [
  // --- FRENCH QUIZZES (كويزات مادة اللغة الفرنسية) ---
  // Quiz for G2B on Monday (Warning appears on Sunday in Tomorrow)
  {
    id: 'tn-w2-g2b-mon-french-quiz',
    classId: 'G2B',
    targetDay: 'Monday',
    subject: 'French',
    note: 'Remarque: Quiz de Français sur la leçon (Les nombres et les jours de la semaine / tous les jours)',
    arabicNote: '🚨 Remarque: كويز فرنسي (Quiz Français) يوم الإثنين - مراجعة الأعداد وأيام الأسبوع (tous les jours de la semaine ص 16 و 18 و 19)',
  ...
  // Quiz for G2C on Monday (Warning appears on Sunday in Tomorrow) - tous les jours
  {
    id: 'tn-w2-g2c-mon-french-quiz',
    classId: 'G2C',
    targetDay: 'Monday',
    subject: 'French',
    note: 'Remarque: Quiz de Français sur la leçon (Les nombres et les jours de la semaine / tous les jours)',
  ...
  // Quiz for G2A on Wednesday (Warning appears on Tuesday in Tomorrow)
  {
    id: 'tn-w2-g2a-wed-french-quiz',
    classId: 'G2A',
    targetDay: 'Wednesday',
    subject: 'French',
  ...
  // Thursday - Mathematics Unit 1 Test (All 3 Classes: G2A, G2B, G2C)
  {
    id: 'tn-w2-g2a-thu-math-test',
    classId: 'G2A',
    targetDay: 'Thursday',
    subject: 'Mathematics',
    note: 'Unit 1: Test in Mathematics. Review addition strategies, 1 more, 1 less, and estimation. Please bring small white board, marker and 100 chart.',
    arabicNote: '🚨 اختبار رياضيات (Unit 1: Test) يوم الخميس - مراجعة دروس الوحدة الأولى (استراتيجيات الجمع، تقدير الأعداد، 1 أكثر و 1 أقل) وإحضار سبورة بيضاء صغيرة وقلم سبورة ومخطط الـ 100 وكتاب وكشكول الماث.',
...
export const WEEK2_CLASSWORK: ClassworkEntry[] = [
  ...
  },
  {
    ...
    period: 5,
    subject: 'Mathematics',
    title: '🚨 اختبار رياضيات: Unit 1: Test',
    details: 'Unit 1 Mathematics Test. اختبار الوحدة الأولى في مادة الرياضيات لجميع الفصول.',
    pages: 'Maths-Grade2-B1-All-Sheet1 - Main',
    completed: false,
    week: 2,
  },
  ...
  },
  {
    ...
    subject: 'French',
    title: '🚨 كويز فرنسي: Quiz de Français & Révision (tous les jours de la semaine et les nombres)',
    details: 'اختبار قصير (Quiz) في مادة اللغة الفرنسية + مراجعة الأعداد وأيام الأسبوع (tous les jours).',
    pages: 'Pages 16, 18 & 19',
    completed: false,
    week: 2,
    linkUrl: 'https://kahoot.it/solo/02420827?challenge-id=7feb71cb-9cdf-43f6-888a-1a97039524af_1758279666900',
