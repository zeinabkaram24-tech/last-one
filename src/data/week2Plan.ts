...
export const WEEK2_SPECIAL_NOTES: TomorrowSpecialNote[] = [
  ...
  // Prep for Sunday (Saturday night) - Arabic Listening Prep
  {
    id: 'tn-w2-g2a-sun-ar-prep',
    classId: 'G2A',
    targetDay: 'Sunday',
    subject: 'Arabic',
  ...
  // Prep for Wednesday (Tuesday night) - Dictation Alert (إنذار وتنبيه الإملاء قبلها بيوم)
  {
    id: 'tn-w2-g2a-wed-ar-dict-alert',
    classId: 'G2A',
    targetDay: 'Wednesday',
    subject: 'Arabic',
  ...
  {
    id: 'tn-w2-g2b-wed-ar-dict-alert',
    classId: 'G2B',
    targetDay: 'Wednesday',
    subject: 'Arabic',
    note: 'Arabic Dictation in Student Notebook tomorrow',
  ...
  {
    id: 'tn-w2-g2c-wed-ar-dict-alert',
    classId: 'G2C',
    targetDay: 'Wednesday',
    subject: 'Arabic',
    note: 'Arabic Dictation in Student Notebook tomorrow',
...
export const ALL_LINK_AND_WEEK2_HOMEWORK: HomeworkEntry[] = [
  ...
  // --- Arabic HW: Sunday (Assigned Sunday, Due Monday) ---
  {
    id: 'hw-w2-ar-sun-g2a',
    classId: 'G2A',
    assignedDay: 'Sunday',
  ...
  // --- Arabic HW: Tuesday Workbook p. 37-38 (Assigned Tuesday, Due Wednesday) ---
  {
  ...
  // --- Arabic Dictation Alert: Tuesday in Homework (One day before Wednesday dictation) ---
  {
    id: 'hw-w2-ar-tue-g2a-dict-alert',
    classId: 'G2A',
    assignedDay: 'Tuesday',
    dueDay: 'Wednesday',
    subject: 'Arabic',
  ...
  {
    id: 'hw-w2-ar-tue-g2b-dict-alert',
    classId: 'G2B',
    assignedDay: 'Tuesday',
    dueDay: 'Wednesday',
    subject: 'Arabic',
  ...
  {
    id: 'hw-w2-ar-tue-g2c-dict-alert',
    classId: 'G2C',
    assignedDay: 'Tuesday',
    dueDay: 'Wednesday',
    subject: 'Arabic',
