...
export const WEEK4_SOCIAL_STUDIES_CLASSWORK: ClassworkEntry[] = [
  {
    ...
    details: "الدرس الأول: سلوكي يحافظ على بيئتي - التعرف على السلوكيات الإيجابية والمسؤولة التي تساعد في الحفاظ على البيئة المحيطة بنا وحمايتها من التلوث.",
...
export const WEEK4_SOCIAL_STUDIES_HOMEWORK: HomeworkEntry[] = [
  {
    ...
    dueDay: "Sunday",
    subject: "Social Studies",
    task: "حل شيت الواجب المنزلي لدرس منزلي ومدرستي",
    details: "يتم إرسال الواجب المنزلي يوم الأربعاء ويتم استلامه أول حصة في الأسبوع (الأحد).",
    pages: "شيت الواجب المنزلي (المرسل يوم الأربعاء)",
    completed: false,
    priority: "normal",
    block: 1,
    week: 4,
  ...
  },
  {
    ...
    subject: "Social Studies",
    task: "حل شيت الواجب المنزلي لدرس منزلي ومدرستي",
    details: "يتم إرسال الواجب المنزلي يوم الأربعاء ويتم استلامه أول حصة في الأسبوع (الإثنين).",
    pages: "شيت الواجب المنزلي (المرسل يوم الأربعاء)",
    completed: false,
    priority: "normal",
    block: 1,
